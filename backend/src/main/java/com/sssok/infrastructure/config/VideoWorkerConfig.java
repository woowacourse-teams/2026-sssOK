...
public class VideoWorkerConfig {
    ...
    public Executor videoThumbnailTaskExecutor(VideoWorkerProperties properties) {
        return taskExecutor("video-thumbnail-", properties.coreSize(), properties.maxSize(),
            properties.queueCapacity());
    }

    private Executor taskExecutor(String threadNamePrefix, int coreSize, int maxSize,
                                  int queueCapacity) {
